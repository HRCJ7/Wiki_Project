...
import com.example.mapapplication.di.component.DaggerFragmentComponent
import com.example.mapapplication.di.component.FragmentComponent
import com.example.mapapplication.di.module.FragmentModule
import com.example.mapapplication.utils.display.Toaster
...
abstract class BaseFragment<VM : BaseViewModel> : Fragment() {
    ...
    private fun buildFragmentComponent() =
            DaggerFragmentComponent
                    .builder()
                    .applicationComponent((requireContext().applicationContext as MapApplication).applicationComponent)
